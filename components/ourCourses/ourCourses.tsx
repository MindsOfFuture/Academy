  ...
  return (
    <div className="flex flex-col  h-[auto] items-center ">
        <div className="container mx-auto p-8">
          <h2 className="text-3xl ont-bold ">Nossos Cursos</h2>
          <p className='w-[480px]'>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi hendrerit vulputate risus. Nulla a eros nisi. Donec condimentum.</p>
        </div>
          ...
          <div className="flex h-screen justify-center items-start gap-20 flex-wrap p-6 " >
            {
              cursos.map((curso, index) => (
                <div key={index} className="p-3 rounded-[5] shadow-lg text-black flex flex-col items-start justify-start w-[300px] h-[500px]">
                  <Image src={curso.imageUrl} alt={curso.title} width={430} height={72} className="w-[100%] h-[180px] bg-gray-200 p-4" />
